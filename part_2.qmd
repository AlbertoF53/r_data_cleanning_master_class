...
Another option is to use the regular expression find me anything `(.)`. But one dot stands for only one letter. But adding `+` makes it plural. Or of this dot or character, find me as many as you can find.
